        ...
        <div className="grid lg:grid-cols-12 gap-16">
           <div className="lg:col-span-5">
              <div className="sticky top-32">
                ...
                <button className="group flex items-center gap-3 text-lg font-medium hover:text-gray-300 transition-colors bg-white/10 px-6 py-3 rounded-full w-fit backdrop-blur-sm border border-white/10 hover:bg-white/20">
           ...
           <div className="lg:col-span-7 grid sm:grid-cols-2 gap-x-10 gap-y-16">
              {values.map((val, idx) => (
                 <div key={idx} className="group">
                    <div className="w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-white/10 transition-colors border border-white/10">
