                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 p-6 rounded-[2rem] bg-brand-gray-lighter/50 border border-brand-gray-lighter">
                          ...
                          <p className="text-[10px] font-bold text-brand-gray leading-relaxed uppercase tracking-widest">
                            Your payment is encrypted and handled by Replit Native Auth & Pay
                          </p>
                        </div>

                        <Button className="w-full h-20 rounded-full bg-brand-blue text-white hover:bg-brand-black shadow-2xl shadow-brand-blue/30 text-xl font-black transition-all group scale-100 hover:scale-[1.02] active:scale-[0.98]">
                          Pay ${product.total + selectedDelivery.price}
